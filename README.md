...
### 🆕 v6.0.0 更新内容（粒子系统全新重构）
- **新增**：完整MediaPipe Hands集成，五态手势识别
- **新增**：无摄像头演示模式，自动手势模拟
- **新增**：实时状态HUD和性能监控
- **优化**：粒子尺寸从0.04降至0.015，极致轻量
- **优化**：物理引擎重构，双缓冲加速结构
- **优化**：UI全面重设计，玻璃拟态+青色辉光
- **优化**：响应式设计，移动端完美适配
- **增强**：挥手风暴效果，速度检测+风力场
- **增强**：深度推拉反馈，0.7×-2.4×平滑缩放
- **增强**：错误降级和自动恢复机制

### 📊 系统参数对比
| 系统 | 粒子数量 | 粒子尺寸 | 分布方式 | 特效特性 |
|------|----------|----------|----------|----------|
| **粒子系统** | **16,000** | **0.015** | **Fibonacci球面** | **物理引擎、手势五态、风暴效果** |
| 星球核心 | 4,000 | 0.8-2.3 | 球面分布(8-10半径) | 自转(0.002)、橙色 |
| 星球星环 | 3,000 | 0.6 | 双环结构(14-18,22-26) | 自转(-0.001)、白色 |
| 星球照片 | 9个位置 | 自适应 | 3D空间固定位置 | 透明度0.6、智能朝向 |
